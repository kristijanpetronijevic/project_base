...
int main() {
    ...
    pointLight.position = glm::vec3(10.0f, 5.0f, -70.0f);
    ...
    vector<std::string> faces
            {
                    FileSystem::getPath("resources/textures/skybox/Daylight Box_Right.bmp"),
                    FileSystem::getPath("resources/textures/skybox/Daylight Box_Left.bmp"),
                    FileSystem::getPath("resources/textures/skybox/Daylight Box_Bottom.bmp"),
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ourShader.setFloat("spotLight.quadratic", 0.0000032);
